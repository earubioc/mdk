...
const es = {
  ...
  'menu.file.openRecentEmpty': '(sin archivos recientes)',
  'menu.file.clearRecent': 'Limpiar lista',
  ...
  'menu.view': 'Ver',
  'menu.view.editMode': 'Solo editor',
  'menu.view.preview': 'Solo vista previa',
  'menu.view.split': 'Editor y vista previa',
  ...
  'toolbar.editorTitle': 'Solo editor (Ctrl+Shift+E)',
  'toolbar.previewBtn': 'Vista previa',
  'toolbar.previewTitle': 'Solo vista previa (Ctrl+Shift+V)',
  'toolbar.splitBtn': 'Ambos',
  'toolbar.splitTitle': 'Editor y vista previa lado a lado (Ctrl+Shift+B)',
  ...
  'changelog.2.6.1': 'La vista previa ya usa todo el ancho disponible (antes era una columna fija de 720px). Vista dividida rediseñada: un solo botón "Ambos" en vez de dos independientes, y el divisor entre paneles ahora se puede arrastrar.',
  'changelog.2.6.0': 'Corregidas las tablas Markdown (no se veían ni en la vista previa ni en el PDF). Nuevo: "Abrir reciente" en el menú Archivo, con los últimos 15 archivos.',
  'changelog.2.5.1': 'El listado de novedades del panel de información ahora tiene scroll interno, en vez de crecer sin límite.',
  'changelog.2.5.0': 'Corregido: abrir un .md con doble clic o arrastrarlo a la ventana ahora sí carga el documento (antes abría en blanco o en una pantalla rara). Vista dividida: Editor y Vista previa se pueden encender juntos.',
...
const en = {
  ...
  'menu.file.clearRecent': 'Clear List',
  'menu.file.save': 'Save',
  ...
  'menu.view': 'View',
  'menu.view.editMode': 'Editor Only',
  'menu.view.preview': 'Preview Only',
  'menu.view.split': 'Editor and Preview',
  ...
  'toolbar.editorBtn': 'Editor',
  'toolbar.editorTitle': 'Editor only (Ctrl+Shift+E)',
  'toolbar.previewBtn': 'Preview',
  'toolbar.previewTitle': 'Preview only (Ctrl+Shift+V)',
  'toolbar.splitBtn': 'Both',
  'toolbar.splitTitle': 'Editor and preview side by side (Ctrl+Shift+B)',
  ...
  'changelog.2.6.1': 'Preview now uses the full available width (it used to be a fixed 720px column). Split view redesigned: a single "Both" button instead of two independent toggles, and the divider between panes can now be dragged.',
  'changelog.2.6.0': 'Fixed Markdown tables (they weren\'t rendering in preview or PDF). New: "Open Recent" in the File menu, with the last 15 files.',
  'changelog.2.5.1': 'The changelog list in the info panel now scrolls internally instead of growing without limit.',
  'changelog.2.5.0': 'Fixed: double-clicking or dragging a .md file into the window now actually loads the document (it used to open blank or in an odd screen). Split view: Editor and Preview can now be on at the same time.',
