...
const es = {
  ...
  'toolbar.editorTitle': 'Mostrar/ocultar editor (Ctrl+Shift+E)',
  'toolbar.previewBtn': 'Vista previa',
  'toolbar.previewTitle': 'Mostrar/ocultar vista previa — enciende los dos para ver ambos a la vez (Ctrl+Shift+V)',
...
const en = {
  ...
  'toolbar.editorBtn': 'Editor',
  'toolbar.editorTitle': 'Show/hide editor (Ctrl+Shift+E)',
  'toolbar.previewBtn': 'Preview',
  'toolbar.previewTitle': 'Show/hide preview — turn both on to see them side by side (Ctrl+Shift+V)',
